...
class MarketsController extends Controller
{
    ...
    public $_route         = "market.markets";
    public $_dir           = "market.markets";
    public $_menu_group    = "Market Information";
    public $_page_title    = 'Markets';
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Market::select(['*', DB::raw('@DT_RowIndex  := @DT_RowIndex  + 1 AS DT_RowIndex') ])->orderBy('name', 'ASC');
