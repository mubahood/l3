...
{
    public $_permission    = "trainings";
    public $_route         = "trainings.trainings";
    public $_dir           = "trainings.trainings";
    public $_menu_group    = "Training";
    public $_page_title    = 'Trainings';
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Training::select(['*', DB::raw('@DT_RowIndex  := @DT_RowIndex  + 1 AS DT_RowIndex') ])->orderBy('date', 'DESC');
            ...
            return $datatables
                ...
                ->addColumn('farmers', function($data) {
                    // return $data->id;
                  })
