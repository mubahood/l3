...
{
    public $_permission    = "permissions";
    public $_route         = "user-management.permissions";
    public $_dir           = "user_management.permissions";
    public $_menu_group    = "User Management";
    public $_page_title    = 'Permissions';
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Permission::select(['*', DB::raw('@DT_RowIndex  := @DT_RowIndex  + 1 AS DT_RowIndex') ])->orderBy('name', 'ASC');
