...
{
    public $_permission    = "roles";
    public $_route         = "user-management.roles";
    public $_dir           = "user_management.roles";
    public $_menu_group    = "User Management";
    public $_page_title    = 'Roles';
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Role::select(['*', DB::raw('@DT_RowIndex  := @DT_RowIndex  + 1 AS DT_RowIndex') ])->orderBy('name', 'ASC');
