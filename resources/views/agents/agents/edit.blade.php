        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$agent->id]) }}">Agent details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit agent</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                             {!! Form::model($agent, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['village-agents.agents.update', $agent->id]]) !!}
                                ...
                                <div class="form-group mb-3">
                                    {!! Form::label('village_agent_id', 'Supervisor (If supervised)', ['class' => 'col-sm-3 form-label']) !!}
                                    <div class="col-sm-5">
                                        {!! Form::select('village_agent_id', $agents, old('village_agent_id'), ['class' => 'form-control select2','placeholder'=>'--Select--']) !!} 
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    {!! Form::label('services', 'Phone number (optional)', ['class' => 'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" name="is_mm_phone" type="radio" value="1"> YES</label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                               <input class="form-check-input" name="is_mm_phone" type="radio" value="0"> NO</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        {!! Form::text('mm_phone', old('mm_phone'), ['class' => 'form-control', 'placeholder' => '775xxxxxx']) !!}
                                    </div>                                         
                                </div> 
