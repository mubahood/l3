        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('alerts.bulk.create') }}">Send bulk alert</a></li>
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => ['alerts.alerts.store'], 'files' => true]) !!} 
                                ...
                                <input type="hidden" name="type" value="recipients">
                                ...
                                <div class="form-group mb-3">
                                   {!! Form::label('file', 'Choose excel spreadsheet to upload (.xls, .xlsx, .csv)', ['class' => 'col-sm-4 col-form-label']) !!}
                                <div class="col-sm-5">
                                    <input id="input-2" name="recipients" type="file" class="file" data-show-upload="true" data-show-caption="true" accept=".xls, .xlsx, .csv">
                                </div>
                                    </div>  
