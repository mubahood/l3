        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('alerts.farmer-group.create') }}">Send to farmer groups</a></li>
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => ['alerts.alerts.store'],'files' => true]) !!} 
                                ...
                                <input type="hidden" name="type" value="farmer_groups">
                                ...
                                <div class="form-group mb-3">
                                    {!! Form::label('languages', 'Farmer groups (required)', ['class' => 'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-5">
                                        {!! Form::select('groups[]', $groups, old('groups'), ['class' => 'form-control js-example-basic-multiple select2-hidden-accessible', 'multiple'=>'']) !!} 
                                    </div> 
                                </div>
