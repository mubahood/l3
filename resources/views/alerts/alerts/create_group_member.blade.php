        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('alerts.group-member.create') }}">Send to group members</a></li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => ['alerts.alerts.store'],'files' => true]) !!} 
                                ...
                                <input type="hidden" name="type" value="group_members">
                                ...
                                <div class="form-group mb-3">
                                    {!! Form::label('farmer_group_id', 'Farmer group (required)', ['class' => 'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-5">
                                        {!! Form::select('farmer_group_id', $groups, old('farmer_group_id'), ['class' => 'form-control select2','required' => '','placeholder'=>'--Select--']) !!} 
                                    </div> 
                                </div>                                 

                                <div class="form-group mb-3">
                                    {!! Form::label('farmers', 'farmers (required)', ['class' => 'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-5">
                                        {!! Form::select('farmers[]', $farmers ?? [], old('farmers'), ['class' => 'form-control js-example-basic-multiple select2-hidden-accessible', 'multiple'=>'']) !!} 
                                    </div> 
                                </div>
