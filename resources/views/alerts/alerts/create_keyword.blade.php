        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('alerts.keyword.create') }}">Send by language</a></li>
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => ['alerts.alerts.store'],'files' => true]) !!} 
                                ...
                                <div class="row">
                                {!! Form::label('activity', 'Choose recipients (required)', ['class' => 'col-sm-12 form-label']) !!}
                                <div class="col-sm-5">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                          <label class="form-check mb-2">
                                            <input class="form-check-input" name="is_to_farmers" type="checkbox" value="1"><span class="custom-control-label">Farmers
                                            </span>
                                          </label>                     
                                        </div><!-- col-3 -->
                                        <div class="col-lg-4 col-md-4">
                                          <label class="form-check mb-2">
                                            <input class="form-check-input" name="is_village_agents" type="checkbox" value="1"><span class="custom-control-label">Village Agents
                                            </span>
                                          </label>                     
                                        </div><!-- col-3 -->
                                        <div class="col-lg-4 col-md-4">
                                          <label class="form-check mb-2">
                                            <input class="form-check-input" name="is_extension_officers" type="checkbox" value="1"><span class="custom-control-label">Extension Officers
                                            </span>
                                          </label>                     
                                        </div><!-- col-3 -->
                                    </div>
