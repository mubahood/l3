        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('alerts.single.create') }}">Send single alert</a></li>
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => ['alerts.alerts.store'],'files' => true]) !!} 
                                ...
                                <div class="form-group mb-3">
                                    {!! Form::label('recipient', 'Recipient*', ['class' => 'col-sm-4 col-form-label']) !!}                
                                    <div class="col-sm-5">
                                    {!! Form::text('recipient[]', old('recipient'), ['class' => 'form-control', 'placeholder' => 'e.g. 256000000000']) !!}               
                                    </div>
                                </div>
