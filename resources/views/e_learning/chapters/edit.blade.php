        ...
        <div class="card" id="pages">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @can('add_el_chapters')
                        @if ($course->lecture_type != "Weekly")
                            <li class="nav-item"><a class="nav-link" href="{{ url('e-learning/courses/chapters/'.$course->id.'/create') }}">Add Topic</a></li>
                        @endif
                    @endcan
                    @can('edit_el_chapters')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit Topic</a></li>
                    @endcan
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        {!! Form::model($data, ['method' => 'PUT', 'files' => true, 'route' => ['e-learning.chapters.update', $data->id]]) !!}
                        ...
                        <div class="form-group mb-3">
                            {!! Form::label('title', 'Topic*', ['class' => 'col-sm-4 col-form-label']) !!}                
                            <div class="col-sm-5">
                        ...
                        @if ($course->lecture_type != "Weekly")
                            <div class="form-group mb-3">
                                {!! Form::label('summary', 'Heading*', ['class' => 'col-sm-12 col-form-label']) !!}                
                                <div class="col-sm-12">
