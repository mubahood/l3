        ...
        <div class="card" id="pages">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    @endcan
                    @can('edit_el_courses')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit Course</a></li>
                    @endcan
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">

                        {!! Form::model($data, ['method' => 'PUT', 'files' => true, 'route' => ['e-learning.courses.update', $data->id]]) !!}
                        ...
                        <div class="form-group mb-3">
                            <div class="col-sm-12">
                                <input type="checkbox" name="read_only_mode" {{ $data->read_only_mode ? 'checked="checked"' : '' }}>
