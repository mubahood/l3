            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    @can('edit_el_instructions')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit Default Message</a></li>
                    @endcan
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">

                        {!! Form::model($data, ['method' => 'PUT', 'files' => true, 'route' => ['e-learning.messages.update', $data->id]]) !!}
