            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    @can('view_el_instructions')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Default Message</a></li>
                    @endcan
                    @can('edit_el_instructions')
                        <li class="nav-item"><a class="nav-link" href="{{ route('e-learning.messages.edit', $data->id) }}">Edit Default Message</a></li>
                    @endcan
                </ul>
