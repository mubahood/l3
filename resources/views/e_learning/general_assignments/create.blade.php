        ...
        <div class="card" id="pages">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @endcan
                    @can('add_el_lectures')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Add Question</a></li>
                    @endcan
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">
                        
                        {!! Form::open(['method' => 'POST', 'files' => true, 'route' => ['e-learning.general-assignments.store']]) !!}
