            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    @can('edit_el_instructors')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit Instructor Profile</a></li>
                    @endcan
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">

                        {!! Form::model($data, ['method' => 'PUT', 'route' => ['e-learning.instructors.update', $data->id]]) !!}
                        
                        <input type="hidden" name="role_id" value="{{ $data->user->roles->pluck('id')->first() }}">
                        ...
                        {{-- @php($data->email = $data->user->email)
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="col-sm-5">
                            {!! Form::text('phone_number', old('phone_number'), ['class' => 'form-control', 'placeholder' => '07...']) !!}               
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            {!! Form::label('village', 'Village', ['class' => 'col-sm-4 col-form-label']) !!}                
                            <div class="col-sm-5">
                        ...
                        <div class="form-group mb-3">
                            {!! Form::label('business', 'Business', ['class' => 'col-sm-4 col-form-label']) !!}                
                            <div class="col-sm-5">
