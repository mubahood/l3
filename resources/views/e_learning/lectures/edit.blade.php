            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @can('edit_el_lectures')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit Lecture</a></li>
                    @endcan
                    @can('list_el_lectures')
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        {!! Form::model($data, ['method' => 'PUT', 'files' => true, 'route' => ['e-learning.lectures.update', $data->id]]) !!}
