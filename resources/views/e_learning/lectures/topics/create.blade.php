            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">                    
                    ...
                    @can('view_el_lectures')
                        <li class="nav-item"><a class="nav-link" href="{{ route('e-learning.lectures.show', $data->id) }}">Lecture Detail</a></li>
                    @endcan
                    @can('add_el_lecture_topics')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">New Discussion Topic</a></li>
                    @endcan
                    @can('list_el_lectures')
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                       ...
                       {!! Form::open(['method' => 'POST', 'files' => true, 'url' => ['e-learning/courses/lectures/topics/store']]) !!}
