            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">  
                    ...
                    @can('add_el_course_instructions')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Update Message</a></li>
                    @endcan
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active">
                        
                        {!! Form::open(['method' => 'POST', 'files' => true, 'route' => ['e-learning.course-messages.store']]) !!}
                        ...
                        <div class="form-group mb-3">
                            {!! Form::label('message_id', 'Message', ['class' => 'col-sm-4 col-form-label']) !!}                
                            <div class="col-sm-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="col-sm-12">
                            {!! Form::textarea('text_message', null, ['class' => 'form-control','rows'=>2]) !!}
                            </div>
                        </div>
