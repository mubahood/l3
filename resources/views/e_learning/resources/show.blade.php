                                            ...
                                            @foreach ($data->discussions as $discussion)
                                                <section class="event card border">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h4 class="event-heading"><a href="#">{{ $discussion->user->name ?? $discussion->student->full_name }}</a><span><small class="text-muted"><a href="#">&nbsp;{{ $data->user->telephone ?? $discussion->student->phone_number }}</a></small></span></h4>
