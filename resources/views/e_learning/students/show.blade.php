...
@section('extra-buttons')
    <div class="ml-auto">
        ...
        @if (auth()->user()->hasRole('instructor'))
          <a href="{{ route('e-learning.students.picture.change', $data->id) }}"  class="btn btn-primary btn-icon text-white mr-2" data-toggle="tooltip" title="" data-placement="bottom">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    @can('view_el_students')
                        <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Student Profile</a></li>
                    @endcan
