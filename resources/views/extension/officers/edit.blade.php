        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$officer->id]) }}">Extension officer details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit extension officer</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                                 ...
                                 {!! Form::model($officer, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['extension-officers.officers.update', $officer->id]]) !!}
                                    ...
                                    <div class="form-group mb-3">
                                        {!! Form::label('position_id', 'Position (optional)', ['class' => 'col-sm-3 form-label']) !!}             
                                        <div class="col-sm-5">
                                       {!! Form::select('position_id', $positions, old('position_id'), ['class' => 'form-control select2','placeholder'=>'--Select--']) !!}    
                                        </div>
                                    </div>
