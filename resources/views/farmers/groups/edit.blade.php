        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit farmer group</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                         ...
                         {!! Form::model($group, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['farmers.groups.update', $group->id]]) !!}
                            ...
                            <div class="form-group mb-3">
                                {!! Form::label('other_activities', 'Other activities(optional)', ['class' => 'col-sm-3 form-label']) !!}                
                                <div class="col-sm-5">
                                {!! Form::text('other_activities', old('other_activities'), ['class' => 'form-control', 'placeholder' => 'e.g. activity1, activity2, activity3']) !!}               
                                </div>
                            </div>
