        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$price->id]) }}">Farmer details</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::model($price, ['files'=>true, 'class'=>'form-horizontal', 'method' => 'PATCH','route' => [$set->_route.'.store', $price->id]]) !!}             
