        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.index') }}">List of LPO settings</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Add new LPO settings</a></li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['files' => true, 'method' => 'POST', 'route' => [$set->_route.'.store']]) !!}
                                ...
                                <div class="form-group mb-3">
                                {!! Form::label('file', 'Approver\'s Signature (optional)', ['class' => 'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-5">
