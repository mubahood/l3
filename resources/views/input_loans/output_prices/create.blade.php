        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.index') }}">List of output prices</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Add new output prices</a></li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => [$set->_route.'.store']]) !!}               
                                    ...
                                    <div class="form-group mb-3">
                                        {!! Form::label('buyer_id', 'Buyer (required)', ['class' => 'col-sm-4 col-form-label']) !!}                
                                        <div class="col-sm-5">
                                        {!! Form::select('buyer_id', $buyers, old('buyer_id'), ['class' => 'form-control select2','placeholder'=>'--Select--','required' => '']) !!}    
                                        </div>
                                    </div>                                  
