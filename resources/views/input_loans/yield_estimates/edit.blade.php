        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$yield->id]) }}">Yield estimates details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit yield estimates</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::model($yield, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['settings.enterprises.update', $yield->id]]) !!}
