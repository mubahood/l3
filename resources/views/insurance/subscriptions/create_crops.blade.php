        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route($set->_route.'.create-crops') }}">Subscribe farmer (Crop)</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            @include('insurance.subscriptions.create', ['category' => 'crop'])
