@inject('set', 'App\Http\Controllers\MarketInformation\OnRequestKeywordController')
@extends('layouts.app')
...
@include('partials.breadcrumb',[
    ...
    'menu_item'     => 'Keyword Pricing (On-Request)',
                        ...
                        <!-- content starts here -->
                            ...
                            {!! Form::open(['method' => 'POST', 'route' => [$set->_route.'.store']]) !!}
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="sms" type="radio" maxlength="159"></textarea>
                                         <span>SMS must not exceed 160 characters</span>
                                    </div>
                                </div>
