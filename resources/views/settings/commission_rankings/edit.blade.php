        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$ranking->id]) }}">Country details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit commission ranking</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        {!! Form::model($ranking, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['settings.commission-rankings.update', $ranking->id]]) !!}
