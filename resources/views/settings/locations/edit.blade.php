        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',[$location->id]) }}">Location details</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit location</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        {!! Form::model($location, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['settings.locations.update', $location->id]]) !!}
