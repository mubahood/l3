        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Region details</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.edit',[$region->id]) }}">Edit region</a></li>
                </ul>
                <!-- Tab panes -->
