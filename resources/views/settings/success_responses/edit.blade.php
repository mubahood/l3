        ...
        <div class="card" id="pages">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.index') }}">List of success responses</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.create') }}">Add new success response</a></li>
                    {{-- <li class="nav-item"><a class="nav-link" href="{{ route($set->_route.'.show',$response->id) }}">Success response details</a></li> --}}
                    <li class="nav-item"><a class="nav-link active" href="{{ url()->current() }}">Edit success response</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane active">
                        <!-- content starts here -->
                            ...
                            {!! Form::model($response, ['class'=>'form-horizontal', 'method' => 'PATCH','route' => ['settings.success-responses.update', $response->id]]) !!}
